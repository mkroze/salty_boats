        ...
        <body>
          <div className="pt-20">
              ...
              <div className="rounded-lg md:w-2/3">
                {cartItems.map((item) => {
                  return (
                    <div className="border-lgreen border h-54 justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
                      <img
                        src={item.image}
                        alt={item.name}
                      ...
                      <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                        <div className="mt-5 sm:mt-0">
                          <h2 className="text-lg font-bold text-lgreen">
                            {item.name}
                          </h2>
              ...
              <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                ...
                <button 
                className="mt-6 w-full rounded-md bg-lgreen py-1.5 font-medium text-blue-50 hover:bg-dblue"
