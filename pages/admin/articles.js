              ...
              <table className="min-w-full">
                <thead className="border-b">
                  <tr className="rounded-md">
                    ...
                    <th className="p-5 text-left bg-lgreen">Titre</th>
                    <th className="p-5 text-left bg-lgreen">Image</th>
                    <th className="p-5 text-left bg-lgreen">Resume</th>
                    <th className="p-5 text-left bg-lgreen">Description</th>
                    <th className="p-5 text-left bg-lgreen rounded-r-md">
                      Actions
                    </th>
                  </tr>
                </thead>
