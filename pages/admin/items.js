              ...
              <table className="min-w-full">
                <thead className="border-b">
                  <tr className='rounded-md'>
                    <th className="px-5 text-left bg-lgreen rounded-l-md">ID</th>
                    <th className="p-5 text-left bg-lgreen">Nom</th>
                    <th className="p-5 text-left bg-lgreen">Prix</th>
                    <th className="p-5 text-left bg-lgreen">Catégorie</th>
                    <th className="p-5 text-left bg-lgreen">Quantité</th>
                    <th className="p-5 text-left bg-lgreen">Note</th>
                ...
                <tbody>
                  {items.map((item) => (
                    <tr key={item._id} className="border-b">
                      ...
                      <td className=" p-5 ">
                      <a href={`/admin/item/${item._id}`} type="button" className="mt-6 rounded-md bg-lgreen py-1.5 font-medium text-blue-50 hover:bg-dblue">
                            Edit
                          </a>
                        &nbsp;
                        <button
